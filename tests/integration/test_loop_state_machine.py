...
class _MockLeadAgent:
    ...
    async def propose_pivot(self, current_metrics, history, escalation_level=0, current_algorithm="PPO", algorithm_locked=False, current_policy_kwargs=None, current_hyperparameters=None, current_env_kwargs=None):
...
async def test_plateau_triggers_pivot_then_goal_met(seeded_mission, db_session, patch_db, monkeypatch):
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        async def _track_pivot(m, h, escalation_level=0, current_algorithm="PPO", algorithm_locked=False, current_policy_kwargs=None, current_hyperparameters=None, current_env_kwargs=None):
