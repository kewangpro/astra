...
- **464 tests** — 455 unit + 9 integration tests covering all core services
...
| 15 | Sandbox Lifecycle Hardening — orphaned subprocess fix (reattach kill-by-pid), stale sandbox eviction before launch, 464 tests | ✅ Complete |
