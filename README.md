...
- **301 tests** — unit coverage across all core services (evolution, KV cache, crystallizer, preflight, state recovery, error analyzer, code generator, safety classifier, pivot clamping, specialist evaluator, missions router) plus integration tests for the full loop
...
├── tests/
│   ├── unit/           # 295 unit tests across all core modules
