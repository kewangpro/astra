...
├── tests/
│   ├── unit/           # 418 unit tests across all core modules
...
| 12 | Mission Lifecycle & Telemetry — clean deletion, sandbox error detection, goal metric cap, pivot context, 426 tests | ✅ Complete |
